...
<div class="container" style="padding-top: 10px;">
	...
	<hr>
	<form method="post" name="addBook" action="<?php echo base_url().'index.php/Book/add'; ?>">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<input type="text" name="isbn_number" value="<?php echo set_value('isbn_number')?>" class="form-control">
